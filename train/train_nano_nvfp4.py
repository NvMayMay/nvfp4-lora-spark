...
Mirror of `day5_super_full_train.py` so the 4-way Day 6 eval (Nano-base vs Nano-FT vs Super-base
...
def main():
    print("=== Day 5b: Nano-30B LoRA on ICH v3.1, 1 epoch, max_len=1536 (comparable to Super) ===")
